...
public class Response {
	...
	public Response(int sl_no, String business_code, int cust_number, String clear_date, String buisness_year,
			String doc_id, String posting_date,String document_create_date, String document_create_date1, String due_in_date,
			String invoice_currency, String document_type, String posting_id, String area_business,
			double total_open_amount, String baseline_create_date, String cust_payment_terms, int invoice_id, int isOpen,
			String aging_bucket, int isdeleted) {
		super();
		this.sl_no = sl_no;
		this.posting_date = posting_date;
		this.business_code = business_code;
